...
<body>
    ...
    <div id="preloader">
        ...
        <div class="prelogo">
            ...
            <p>Get your essentials fast and safely!</p>
        </div>
    </div>
    <!-- ----------------------------------------------------------------------- -->
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                                        ...
                                        <div class="cartBoard offcanvas-body">
                                            <div class="cartItem d-flex">
                                                <div class="col-3">
                                                    <a href="./item.html"><img src="{{ asset('frontend/images/aamm.png') }}" alt="" class="img-fluid"></a>
                                                </div>
                                                <div class="col-9">
                                                    <div class="cnt">
   ...
   <div class="container">
                           ...
                           <div class="appstore">
                               <div class="row align-items-center">
                                   <div class="col-lg-3 col-3">
                                       <span class="apps_logo"><iconify-icon icon="ic:baseline-apple"></iconify-icon></span>
                                   </div>
       ...
       <div class="row align-items-center justify-content-lg-between copyright">
           ...
           <div class="col-lg-4 d-lg-flex justify-content-lg-end">
               <img src="{{ asset('frontend/images/Payment Method.png') }}" class="img-fluid payment_img" alt="">
           </div>
       </div>
   </div>
</footer>
