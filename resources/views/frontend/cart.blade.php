            ...
            <div class="col-lg-12 col-12 d-flex">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="breadCrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item on" aria-current="page">Shopping Cart</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section id="cartTable">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-12 col-md-12">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="added d-flex flex-wrap flex-md-nowrap align-items-center gap-3">
                                        <div class="col-3">
                                            <a href="#"><img src="./images/cart img.png" alt="" class="img-fluid"></a>
                                        </div>
                                        <div class="col-9">
                                            <div class="cnt">
                                                <a href="./item.html" class="productNames">Green Lettuce</a>
                                ...
                                <td>$70.00</td>
                                <td><button><iconify-icon icon="bitcoin-icons:cross-filled"></iconify-icon></button></td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="added d-flex align-items-center gap-3">
                                        <div class="col-3">
                                            <a href="#"><img src="./images/cart img 2.png" alt="" class="img-fluid"></a>
                                        </div>
                                        <div class="col-9">
                                            <div class="cnt">
                                                <a href="./item.html" class="productNames">Green Lettuce</a>
                            ...
                            <tr>
                                <td>
                                    <button class="btnCart" onclick="window.location.href='./shop.html'">Return to shop</button>
                                </td>
                                <td></td>
                                <td></td>
                                <td>
                ...
                <div class="cartPrice col-lg-4">
                    <div class="total">
                        <h6>Cart Total</h6>
                        <div class="itemData d-flex justify-content-between">
                            <p>Subtotal:</p>
                            <span>$84.99</span>
                        </div>
                        <div class="itemData d-flex justify-content-between">
